...
menu = ["Home", "Register", "Login", "Stored_data", "Retrieve Data"]
choice = st.sidebar.selectbox("Navigation", menu)

if choice == "Home":
    st.subheader("Welcome To My 🔐 Data Encryption System Using Strealit!")
...
# ==== user registration ====
    ...
    if st.button("Register"):
        ...
        if time.time() < st.session_state.lockout_time:
            ...
            st.error(" 🔑 Too many failed attempts. Please wait  {remaining} seconds.")      
            st.stop()
    ...
    if not st.session_state.authenticated_user:
        ...
        if st.button("Encrypt And Save"):
            if data and passkey:
                ...
                save_data(stored_data)
                st.success("✅ Data encrypted and save succeessfully!")
